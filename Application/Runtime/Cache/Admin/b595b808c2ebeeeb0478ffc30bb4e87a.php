			...
			<ul class="nav ace-nav">
				<li class="light-blue"> <a data-toggle="dropdown" href="#" class="dropdown-toggle"> <span class="time"><em id="time"></em></span><span class="user-info"><small>欢迎光临,</small>超级管理员</span> <i class="icon-caret-down"></i> </a>
					<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
						...
						<li><a href="javascript:void(0)" name="" title="个人资料" class="iframeurl"><i class="icon-user"></i>个人资料</a></li>
						<li class="divider"></li>
		...
		<div class="sidebar" id="sidebar">
			...
			<div id="menu_style" class="menu_style">
				<ul class="nav nav-list" id="nav_list">
					<li class="home"><a href="javascript:void(0)" name="" class="iframeurl" title=""><i class="icon-list"></i><span class="menu-text"> 系统首页 </span></a></li>
					<li> <a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 个人资料 </span><b class="arrow icon-angle-down"></b></a>
						<ul class="submenu">
							<li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/index/Refund');?>" title="教练信息" class="iframeurl"><i class="icon-double-angle-right"></i>教练信息</a></li>
						</ul> </li>
				</ul>
			</div>
			<script type="text/javascript">
...
<div class="footer_style" id="footerstyle">
	...
	<p class="r_f">地址：南京市鼓楼区阅江楼街道公共路64号 邮编：210011 技术支持：小孟同学</p>
</div>
<!-- /.main-container -->
<!-- basic scripts -->
</body>
